   ...
   z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded "
    >
      <section className="flex justify-between items-center">
        ...
        {userInfo && (
  <button
    className="text-gray-800 flex justify-center items-center gap-5 border border-gray-500  bg-gray-500 p-1 rounded-xl focus:outline-none order-2"
    ...
    >
      ...
      />
          ...
          {dropdownOpen && userInfo && (
            <ul className={`absolute right-6 mt-2 mr-14 w-[10rem] space-y-2 bg-white text-gray-600 ${!userInfo.isAdmin ? "-top-20" :"-top-24"}`}
            >
              {userInfo.isAdmin && (
                <>
                <li>
